...
export default function ForgetPassword() {
  ...
  useEffect(() => {
    ...
    setIsPasswordValid(isPasswordValidCheck && passwordsMatch);
            ...
            {step === 1 && (
              <form onSubmit={handleEmailSubmit} className="space-y-6" noValidate>
                ...
                <button
                  ...
                  className={`btn w-full flex items-center justify-center gap-2 ${isEmailValid && !loading ? 'btn-primary' : 'btn-primary opacity-50 cursor-not-allowed'}`}
                >
            ...
            {step === 2 && (
              <form onSubmit={handleOtpSubmit} className="space-y-6" noValidate>
                ...
                <button
                  ...
                  className={`btn w-full ${otp.join('').length === 6 && !otpLoading ? 'btn-primary' : 'btn-primary opacity-50 cursor-not-allowed'}`}
                >
            ...
            {step === 3 && (
              <form onSubmit={handlePasswordSubmit} className="space-y-6" noValidate>
                ...
                <button
                  ...
                  className={`btn w-full flex items-center justify-center gap-2 ${isPasswordValid && !loading ? 'btn-primary' : 'btn-primary opacity-50 cursor-not-allowed'}`}
                >
