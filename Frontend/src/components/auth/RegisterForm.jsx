...
const RegisterForm = () => {
  ...
  useEffect(() => {
    ...
    const isConfirmPasswordValid = !validators.confirmPassword(confirmPassword);
        ...
        <div className="card border shadow-xl">
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            <button
              ...
              className={`btn w-full flex items-center justify-center gap-2 ${isFormValid && !loading ? 'btn-primary' : 'btn-primary opacity-50 cursor-not-allowed'}`}
            >
              {loading ? (
                'Sending OTP...'
              ) : (
